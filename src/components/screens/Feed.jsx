  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#000000"}}>
      {!posted ? <View style={styles.blurOverlay}>
        <Text style={{fontSize: 20, fontWeight: 600, color:'white', paddingLeft: 14, paddingRight: 14, marginTop:10}}>Today's Q</Text>
        <Text style={{fontSize: 20, fontWeight: 200, color:'white', paddingLeft: 14, paddingRight: 14}}>{question}</Text>
        <Button style={{marginBottom:10, marginTop: 10}} title="Post" onPress={(() => setModalShown(true))}/>
